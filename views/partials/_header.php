<header>
       ...
       <nav class="navigation menu back">
              <ul>
                     ...
                     <li class="link"><a href="index.php?page=list_article">Actualité</a></li>
                     ...
                     <?php } else { ?>
                            <li><a class="hover" href="index.php?page=user_profile">
                                          <?= $auth->getUser()->getPseudo(); ?></a>
                            </li>
                            <li><a class="hover" href="index.php?page=user_logout">Déconnexion</a>
                            </li>
                     <?php } ?>
