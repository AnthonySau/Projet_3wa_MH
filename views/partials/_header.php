        ...
        <ul>
            ...
            <li><a class="univers hover" href="#">Univers</a>
                <ul class="displayNone">
                    ...
                    <li><a class="hover" href="index.php?page=armory_armor">Armures</a></li>
                    <li><a class="hover" href="index.php?page=armory_weapon">Armes</a></li>
            ...
            <?php } else { ?>
            <li><a class="hover" href="#"><?= $auth->getUser()->getPseudo(); ?></a></li>
